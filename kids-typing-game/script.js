...
const LEVEL_WORD_GROUPS = [
  {
    ...
    korean: [
      ...
      "햇님", "호랑이",
      // 추가 단어 (2~4글자, 유아/초등 저학년)
      "가위", "거울", "고래", "곰", "공", "공원", "과자", "그네", "그림", "기린",
      "까마귀", "꽃게", "나비", "낙타", "냉장고", "너구리", "눈사람", "다람쥐", "당근",
      "도토리", "돌고래", "돼지", "두더지", "딸기", "떡", "뚜껑", "막대기", "망아지",
      "모자", "목욕", "무지개", "물고기", "물놀이", "미끄럼", "바나나", "바퀴", "반딧불",
      "방망이", "배추", "뱀", "버섯", "벌레", "보자기", "볼펜", "봉투", "부채",
      "북극곰", "비누", "비둘기", "사마귀", "새우", "소나기", "손수건", "솜사탕",
      "수달", "수탉", "시소", "아기", "아이스크림", "양말",
      "여우", "오리", "올챙이", "참새", "코끼리"
    ]
  },
  {
    ...
    korean: [
      ...
      "풍선", "하모니카", "햄버거", "호수",
      // 추가 단어 (3~6글자, 초등 중학년)
      "가로등", "갈매기", "계단", "고구마", "고드름", "곤충", "공룡", "공부방",
      "구급차", "그림책", "급식", "김밥", "꽃다발", "나팔꽃", "냇가", "노을",
      "다리미", "달력", "대나무", "도마뱀", "도서실", "동생", "두꺼비", "들판", "딱따구리",
      "떡볶이", "마라카스", "모래성", "무당벌레", "미술관", "바지락",
      "반딧불이", "반장", "백합", "버터", "별자리", "보름달", "봉숭아", "분수대", "비행선",
      "삼각형", "새벽", "수돗물", "수선화", "식물원", "아파트",
      "사탕수수", "소방차", "연날리기", "잠자리", "조개껍데기", "참외", "파인애플"
    ]
  },
  {
    id: 3,
    ...
    korean: [
      ...
      "표현", "학습", "행사", "환경", "훈련",
      // 추가 단어 (4~8글자, 초등 고학년)
      "가로수길", "감동", "강수량", "건강검진", "겨울방학", "경복궁", "계획표", "고속도로",
      "공기청정기", "과학관", "관찰일지", "교과서", "구름다리", "국립공원", "그림일기",
      "기후변화", "나비효과", "낙엽", "날씨예보", "독서감상", "동물보호",
      "두뇌운동", "등산로", "리코더", "망원경", "모둠활동", "문화재",
      "미래직업", "민들레", "바다여행", "발명품", "백과사전", "별똥별", "봉사활동",
      "비밀기지", "사진찍기", "생태계", "서식지", "소방서", "수학여행",
      "식물채집", "신재생에너지", "역할극", "우주여행", "운동회", "이산화탄소",
      "자원봉사", "체험학습", "태양에너지", "프레젠테이션"
    ]
  },
  {
    id: 4,
    ...
    korean: [
      ...
      // 추가 단어 (5~20글자, 초등 고학년~중등)
      "가치판단", "감정조절", "개념정리", "경청하기", "공감능력", "공동목표", "과제수행",
      "관계형성", "교우관계", "근거제시", "기술혁신", "논리전개", "다문화이해", "단계별학습",
      "데이터분석", "디지털리터러시", "메타인지", "민주주의", "발표준비",
      "비판적사고", "사회적책임", "상호존중", "생각정리", "세계시민", "소통능력",
      "수행평가", "시간관리", "실생활적용", "심층이해", "언어감각",
      "역사의식", "연구방법", "예술감상", "의사결정", "이해력향상", "인내심",
      "자기성찰", "자기조절", "정보탐색", "지속가능성", "창의적문제해결", "탐구정신",
      "팀워크", "학습동기", "협동학습"
    ]
  }
];
